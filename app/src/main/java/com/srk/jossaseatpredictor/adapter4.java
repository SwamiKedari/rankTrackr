...
public class adapter4 extends RecyclerView.Adapter<adapter4.ViewHolder>{
    ...
    private static adapter4.Listener listener;
    public  static interface Listener{
        public void onClick(int p);
    }
    public adapter4(List<String> a){
        data=a;
    }
    ...
    public static  void setListener(adapter4.Listener l){
        listener=l;
    }
    public adapter4.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        return new adapter4.ViewHolder(cv);

    }
    public void onBindViewHolder(adapter4.ViewHolder holder , @SuppressLint("RecyclerView") int position){
        ...
        TextView q=(TextView) c.findViewById(R.id.quota);
        if(strings.length==4){
            t.setText(strings[0]);
            q.setText(strings[1]);
            f.setText(strings[2]);
